...
public class RequestReceived {
    ...
    public static void onCreate(SQLiteDatabase database) {
        database.execSQL("Create Table RequestReceived(_ID Integer Primary Key autoincrement, UserID Text Not Null, ProfileName Text Not Null,ProfileImage Blob, Quote Text);");
    }

    public static void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {

        // Drop older table if existed
        database.execSQL("Drop Table If Exists RequestReceived;");
        onCreate(database);
    }
