...
public class RequestSent {
    ...
    public static void onCreate(SQLiteDatabase database) {
        database.execSQL("Create Table RequestSent(_ID Integer Primary Key autoincrement, UserID Text Not Null, ProfileName Text Not Null,ProfileImage Blob, Quote Text);");
    }

    public static void onUpgrade(SQLiteDatabase database, int oldVersion, int newVersion) {

        // Drop older table if existed
        database.execSQL("Drop Table If Exists RequestSent;");
        onCreate(database);
    }
